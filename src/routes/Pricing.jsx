...
import { Popover, PopoverHandler, PopoverContent, ThemeProvider, Button } from '@material-tailwind/react';
				...
				<div className="dark:bg-darkMode">
					{windowSize.width > 999 ? (
						<div className=" w-full pt-20 grid grid-col-3 mb-30 items-center margin-auto">
							<p className="text-center text-blueLike  dark:bg-darkMode dark:text-zinc-300 text-5xl font-bold mb-20">
							...
							<div className="flex flex-wrap justify-center md:space-x-4 md:items-stretch">
								<div className="col-span-1 md:min-w-[400px] max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-zinc-900 dark:drop-shadow-xl dark:border-gray-700 ">
									...
									<div className="h-[400px]">
										<ul role="list" className="space-y-5 my-7">
											...
											<li className="flex mt-20 space-x-3">
												{/* <svg aria-hidden="true" className="flex-shrink-0 w-5 h-5 text-gray-200 dark:text-zinc-200" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Check icon</title><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path></svg> */}
												<span className="text-base font-normal leading-tight text-gray-500 dark:text-zinc-300">
													Access Alphy's public database
												</span>
											</li>
											<li className="flex space-x-3">
												{/* <svg aria-hidden="true" className="flex-shrink-0 w-5 h-5 text-gray-200 dark:text-zinc-200" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Check icon</title><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path></svg> */}
												<span className="text-base font-normal leading-tight text-gray-500 dark:text-zinc-300">
													2 hours of free transcription for YouTube
												</span>
											</li>
                                        ...
                                        <span className="text-base font-normal leading-tight text-gray-500 dark:text-zinc-300">Browser Extension</span>
											...
											<li className="flex space-x-1">
												...
												<Popover open={openPopover1} handler={setOpenPopover1}>
													<p className="text-base font-normal leading-tight text-gray-500 dark:text-zinc-300">
														Content popularity limit{' '}
													</p>
													<PopoverHandler {...triggers1}>
														<svg
															className="w-5 h-5 pt-1 opacity-50 text-gray-400 hover:text-gray-500"
															aria-hidden="true"
															fill="currentColor"
															viewBox="0 0 20 20"
													...
													<ThemeProvider value={themePopover}>
														<PopoverContent {...triggers1}>
															<p>
																{' '}
																You can only submit videos with greater than{' '}
																<strong className="underline">10,000 views</strong>
															</p>
														</PopoverContent>
													</ThemeProvider>
												</Popover>
											...
											<li className="flex space-x-3 pt-4">
												<span className="text-base font-normal leading-tight text-gray-500 dark:text-zinc-300"></span>
											</li>
										</ul>
									</div>
									...
									{currentUser ? (
										...
										>
											<Button
												type="button"
												className={` bg-zinc-600  font-semibold ${
													hasActiveSub && !canceledAtPeriodEnd
														? 'bg-zinc-700  dark:bg-darkMode dark:bg-zinc-700'
														: 'pointer-events-none'
												} rounded-lg text-white text-[14px] px-5 py-4 inline-flex justify-center w-full text-center`}
											>
												{currentUser
													? hasActiveSub && !canceledAtPeriodEnd
														? 'Switch Back To Free'
										...
										<a href="/u/login" type="button">
											<Button className="text-white bg-green-400 transition duration-200 ease-in focus:ring-4 focus:outline-none focus:ring-blue-200 dark:focus:ring-blue-900 font-semibold rounded-lg  px-5 py-3 inline-flex justify-center w-full text-center text-white text-[16px]">
								...
								<div className="col-span-2 max-w-sm md:min-w-[400px] p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:bg-zinc-900 dark:drop-shadow-xl dark:border-gray-700 ">
									<h5 className="mb-4 text-xl font-medium text-gray-500 dark:text-zinc-300">
										Premium
									</h5>
									...
									<div className="flex items-baseline text-gray-900 dark:text-white">
										...
										<span className="ml-1 text-xl font-normal text-gray-500 dark:text-zinc-300">
											/month
										</span>
									</div>
									...
									<div className="h-[400px]">
										<ul role="list" className="space-y-5 my-7">
											...
											<li className="flex space-x-3">
												<span className="text-l font-normal leading-tight text-gray-500 dark:text-zinc-300">
											...
											<li className="flex space-x-3">
												<svg
													aria-hidden="true"
													className="flex-shrink-0 w-5 h-5 text-green-400 dark:text-zinc-200"
													fill="currentColor"
													viewBox="0 0 20 20"
													xmlns="http://www.w3.org/2000/svg"
												>
											...
											<li className="flex space-x-3">
												...
												<span className="text-base font-normal leading-tight text-gray-500 dark:text-zinc-300">
													No duration limit for submissions
												</span>
											</li>
													...
													<div className="flex flex-row">
														...
														<ThemeProvider value={themePopover}>
															<PopoverContent {...triggers}>
																<p className="">
																	Generate summaries and ask questions to any content
																	in over 50 languages, regardless of the language of
																	the content.
																	<br></br>
																</p>
															</PopoverContent>
											...
											<li className="flex space-x-3">
												...
												<span className="text-base font-normal leading-tight text-gray-500 dark:text-zinc-300">
													Free Twitter Spaces transcription
												</span>
											</li>
 ...
 */}
									...
									<a
										className={`${hasActiveSub ? 'pointer-events-none' : ''}`}
										href={currentUser && !hasActiveSub && `/plans/checkout`}
									>
										{currentUser ? (
											<Button
												type="button"
												className={` bg-green-400  transition duration-200 ease-in ${
													hasActiveSub && !canceledAtPeriodEnd
														? 'pointer-events-none text-whiteLike'
														: ''
												} rounded-lg text-[16px] font-semibold ]px-5 py-3 inline-flex text-white justify-center w-full text-center`}
											>
												{hasActiveSub && !canceledAtPeriodEnd
													? 'Your Current Plan'
													: canceledAtPeriodEnd
						...
						<div className="mb-20">
							<p className="text-center text-blueLike dark:bg-darkMode dark:text-zinc-300 text-4xl font-semibold mt-20 mb-10">
								Manage Subscription{' '}
							</p>
							{hasActiveSub ? (
								<div className="items-center flex flex-row justify-center">
									<a
										className="text-center text-blueLike dark:bg-darkMode dark:text-zinc-300 text-l mx-auto justify-center underline font-semibold mb-10"
										target="_blank"
										href="https://billing.stripe.com/p/login/test_fZecNT7855nQ2Y0aEE"
									>
										Change your billing plan or cancel subscription
									</a>{' '}
								</div>
							) : null}
							<div className="w-full md:min-w-[400px] items-center mx-auto max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-zinc-900 dark:drop-shadow-xl dark:border-gray-700 mb-10">
								...
								{currentUser ? (
									<a
										target="_blank"
										href={hasActiveSub && 'https://billing.stripe.com/p/login/bIYdTS2Qs9CscfuaEE'}
									>
										{currentUser ? (
											<Button
												type="button"
											...
											<Popover open={openPopover} handler={setOpenPopover}>
												<div className="flex flex-row">
													...
													<ThemeProvider value={themePopover}>
														<PopoverContent {...triggers}>
															<p className="">
																Generate summaries and ask questions to any content in
																over 50 languages, regardless of the language of the
																content.
																<br></br>
															</p>
														</PopoverContent>
                        ...
                        {currentUser ? <button type="button" className="text-white bg-green-400 hover:bg-blue-800 transition duration-200 ease-in font-medium rounded-lg text-l px-5 py-2.5 inline-flex justify-center w-full text-center">{hasActiveSub ? "Your Current Plan" : "Upgrade Plan"}</button> : <div></div>}
                        </a> */}
								<a
									className={`${hasActiveSub && !canceledAtPeriodEnd ? 'pointer-events-none' : ''}`}
									href={currentUser && !hasActiveSub && `/plans/checkout`}
								>
									{currentUser ? (
										<button
											type="button"
											className={`text-white bg-green-400 transition duration-200 ease-in ${
												hasActiveSub & !canceledAtPeriodEnd ? 'pointer-events-none' : ''
											} font-medium rounded-lg text-l px-5 py-2.5 inline-flex justify-center w-full text-center`}
										>
											{hasActiveSub && !canceledAtPeriodEnd
												? 'Your Current Plan'
												: 'Upgrade Plan'}
					...
					<div className="dark:bg-darkMode">
						<div
							id="FAQ"
							className="px-4 mx-auto container w-5/6 max-w-4xl mt-60  pb-20 text-l lg:text-l dark:bg-darkMode dark:text-zinc-300"
						>
							...
							<p className="text-md lg:text-l font-normal">
								{' '}
								If you are using the free version, you have 2 hours of free transcription in total. In
								premium, you get 10 hours of transcription credits every month (on top of your 2 hours
								of credit). If you don't use your credits, they will roll over to the next month. You
								can accumulate up to 30 hours of transcription credits.
							</p>
							<br></br>
							<br></br>

							<h2 className="text-l lg:text-xl  font-normal">
								{' '}
							...
							<p className="text-md lg:text-l">
								{' '}
								If you want to cancel your subscription, you can do so at any time. Your credits will
								still be yours. However you will only be able to access premium benefits until the end
