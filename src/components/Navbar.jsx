	...
	return (
		<div
			className={`items-center ${
				isYt || isSp || isUp ? '' : 'mx-auto max-w-[1200px]'
		...
		>
			...
			>
				<div
					className={`flex items-center font-bold ${collapsed == false && windowWidth > 999 && 'pl-4'} ${
						windowWidth > 999 && (isYt || isSp || isUp) && !collapsed
							? 'bg-zinc-100 dark:bg-mildDarkMode'
							: ''
					} h-[10vh] min-h-[40px] w-[250px] min-w-[250px] 3xl:w-[330px] 3xl:min-w-[330px]`}
				>
					{collapsed == true && (isYt || isSp || isUp) && (
						<div
							onClick={() => setCollapsed(!collapsed)}
							className="hidden lg:flex cursor-pointer bg-zinc-100 dark:bg-mildDarkMode min-w-[32px] max-w-[32px]	h-[10vh]"
						></div>
					)}
					...
					{isYt || isSp || isUp ? (
						<div
							className={`hidden lg:flex 3xl:ml-40 lg:ml-20 pr-4 ${
								collapsed
						...
						About{' '}
							...
							<div className="hidden lg:flex font-normal mr-6 cursor-pointer">
								{isDarkMode === 'dark' ? (
									...
									<svg
										className="mr-2 hover:text-zinc-800 duration-200 transition ease-in"
										width={25}
										onClick={handleDarkMode}
										aria-hidden="true"
										fill="none"
							...
							<div
								...
								className={`block cursor-pointer col-span-3 mr-5 lg:hidden ${
									collapsed ? ' ' : ' open '
								} dark:text-gray-200 dark:invert`}
							>
								<span></span>
								<span></span>
								<span></span>
			...
			<div
				className={`w-screen   dark:bg-darkMode  transition origin-top-right transform lg:hidden ${
						...
						<div className="flex mx-auto flex-row min-w-[300px]">
							...
							<div className="flex font-normal ml-6 cursor-pointer">
								{localStorage.getItem('theme') === 'dark' && !collapsed ? (
									...
									<svg
										className="mr-2 hover:text-zinc-500 duration-200 transition ease-in"
										width={25}
										onClick={handleDarkMode}
										aria-hidden="true"
										fill="none"
